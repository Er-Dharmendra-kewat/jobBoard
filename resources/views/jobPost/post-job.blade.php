...
@section('main-content')
    ...
    <section class="site-section">
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-lg-12">
                    <form action="{{ url('addimage') }}" class="p-4 p-md-5 border rounded" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <h3 class="text-black mb-5 border-bottom pb-2">Job Details</h3>

                        <div class="form-group">
                            <label for="company-website-tw d-block">Upload Company image</label><br>
                            <label class="btn btn-primary btn-md btn-file">
                                Choose File<input type="file" name="image" placeholder="" hidden>
                            </label>
                        ...
                        <div class="form-group">
                            ...
                            <select class="selectpicker border rounded" id="job-region" name="job_region"
                        ...
                        <div class="form-group">
                            ...
                            <select class="selectpicker border rounded" id="job-type" name="job_type"
                        ...
                        <div class="form-group">
                            ...
                            <div class="editor" id="editor-1" name="description">
                                <p>Write Job Description!</p>
                                <textarea name="job_description" id="editor1" class="form-control" placeholder=""></textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="company-website-fb"
