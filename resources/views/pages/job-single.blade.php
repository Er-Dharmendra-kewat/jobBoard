...
@section('main-content')
    {{-- this is common component in all pages --}}
    <!-- HOME -->
    ...
    </section> {{-- this is common component in all pages --}}
    ...
    <section class="site-section">
        <div class="container">
                ...
                <div class="col-lg-8 mb-4 mb-lg-0">
                    <div class="d-flex align-items-center">
                        <div class="border p-2 d-inline-block mr-3 rounded">
                            <img src="{{ url('images/job_logo_5.jpg') }}" alt="Image">
                        </div>
                        <div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        <figure class="mb-5"><img src="{{ url('images/job_single_img_1.jpg') }}" alt="Image"
                ...
                <ul class="job-listings mb-5">
                    ...
                    <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                        ...
                        <div class="job-listing-logo">
                            <img src="{{ url('uploads/employee/'.$item->image)}}" alt="Image" class="img-fluid">
                    ...
                    {{-- <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                        ...
                        <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
                            ...
                            <div class="job-listing-meta">
                                <span class="badge badge-success"> {{ $item->job_type }}</span>
                            </div>
                        </div>
                    </li>
